(()=>{
  const mount=()=>{
    ...
    css.textContent=`
      ...
      .mcp-slide-actions{display:flex;align-items:center;justify-content:center;gap:12px;flex-wrap:wrap;padding:14px 10px 0}
      .mcp-slide-actions:empty{display:none}
      .mcp-slide-actions>.mcp-docked-action,.mcp-slide-actions>.mcp-floating-ui{position:static!important;inset:auto!important;top:auto!important;right:auto!important;bottom:auto!important;left:auto!important;opacity:1!important;pointer-events:auto!important;transform:none!important;margin:0!important;z-index:auto!important;max-width:none!important}
      .mcp-slide-actions>.mcp-docked-action:not(.mcp-docked-robot){min-width:190px!important;width:auto!important;min-height:48px!important}
      .mcp-slide-actions>.mcp-docked-robot{width:54px!important;height:54px!important;min-width:54px!important;min-height:54px!important;display:flex!important;align-items:center!important;justify-content:center!important;border-radius:50%!important}
      @media(max-width:760px){#mcpCrimesPessoaGamma{padding:34px 0}#mcpCrimesPessoaGamma .mcp-gamma-head{display:block}#mcpCrimesPessoaGamma .mcp-gamma-head h2{font-size:28px}#mcpCrimesPessoaGamma .mcp-gamma-wrap{width:min(100% - 20px,1040px)}.mcp-slide-stage{height:390px}.mcp-native-slide{padding:6% 6%;gap:4%}.mcp-slide-copy{width:68%}.mcp-slide-visual{width:28%;font-size:62px}.mcp-slide-controls{padding:9px}.mcp-slide-btn,.mcp-slide-play{padding:8px 10px;font-size:12px}.mcp-slide-actions{gap:8px}.mcp-slide-actions>.mcp-docked-action:not(.mcp-docked-robot){min-width:155px!important;flex:1 1 155px!important}}
      @media(max-width:520px){.mcp-slide-stage{height:360px}.mcp-native-slide{align-items:flex-start;flex-direction:column;justify-content:center}.mcp-slide-copy{width:100%}.mcp-slide-visual{display:none}.mcp-native-slide h3{font-size:27px}.mcp-native-slide p,.mcp-native-slide ul{font-size:14px}.mcp-slide-status{display:none}.mcp-slide-dots{max-width:120px}.mcp-slide-btn,.mcp-slide-play{min-height:36px}.mcp-slide-actions{padding-top:10px}.mcp-slide-actions>.mcp-docked-action:not(.mcp-docked-robot){min-width:135px!important;font-size:13px!important}.mcp-slide-actions>.mcp-docked-robot{width:48px!important;height:48px!important;min-width:48px!important;min-height:48px!important}}
