(()=>{
  ...
  style.textContent=`
    ...
    .mcp-more-panel a[data-mcp-genival="1"]{color:#efbd26!important}
    ...
    @media(max-width:1450px){.brand{min-width:64px!important}.brand span{display:none}.social{display:none!important}}
    @media(max-width:1180px){.header-inner{height:62px!important}.brand{height:62px!important}.nav,.social{display:none!important}.menu{display:block!important;margin-left:auto}.brand{min-width:0!important}.brand span{display:block}.mcp-more{display:none!important}}
