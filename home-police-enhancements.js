(()=>{
  ...
  style.textContent=`
    ...
    .mcp-news-guarulhos{margin:0 0 28px;background:linear-gradient(135deg,#fff,#f8fbff);border:1px solid #d7e1eb;border-left:5px solid #efbd26;border-radius:12px;padding:26px;display:grid;grid-template-columns:1fr auto;gap:24px;align-items:center;box-shadow:0 12px 30px #08203d12}.mcp-news-guarulhos .mcp-news-label{display:inline-flex;align-items:center;gap:7px;background:#062a5d;color:#fff;border-radius:999px;padding:7px 11px;font-size:10px;font-weight:900;letter-spacing:1.3px}.mcp-news-guarulhos h3{font:400 30px/1.15 Georgia,serif;margin:12px 0 8px;color:#08203d}.mcp-news-guarulhos p{margin:0;color:#667583;line-height:1.6}.mcp-news-facts{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}.mcp-news-facts span{background:#eef4f8;color:#234563;padding:7px 9px;border-radius:20px;font-size:10px;font-weight:900}.mcp-news-guarulhos a{display:inline-flex;align-items:center;justify-content:center;background:#efbd26;color:#062a5d;text-decoration:none;padding:15px 19px;border-radius:7px;font-weight:900;white-space:nowrap}.mcp-news-guarulhos a:hover{filter:brightness(1.04)}
    @media(max-width:900px){.mcp-careers,.mcp-actions{grid-template-columns:repeat(2,1fr)}.mcp-news-guarulhos{grid-template-columns:1fr}.mcp-final-grid{grid-template-columns:1fr}.mcp-platforms{grid-template-columns:repeat(2,1fr)}.mcp-q-grid{grid-template-columns:1fr 1fr}.mcp-custody{grid-template-columns:1fr}}
    @media(max-width:560px){.mcp-pcpr{grid-template-columns:1fr}.mcp-news-guarulhos a{width:100%}.mcp-pcpr-cover{height:220px}.mcp-pcpr a,.mcp-custody a{width:100%}#mcpCareerHub{padding:48px 0}.mcp-title{font-size:34px}.mcp-careers,.mcp-actions,.mcp-platforms,.mcp-q-grid{grid-template-columns:1fr}.mcp-central-head{align-items:flex-start;flex-direction:column}.mcp-admin-links{text-align:center;margin-top:-32px}}
  `;
  ...
  block.innerHTML=`<div class="mcp-wrap">
    ...
    <article class="mcp-news-guarulhos" aria-label="Notícia oficial do concurso GCM Guarulhos 2026">
      <div><span class="mcp-news-label">🚨 NOVO CONCURSO • GCM GUARULHOS</span><h3>Guarulhos abre concurso para Guarda Civil Municipal</h3><p>Concurso Público 09/2026-SGE01, organizado pelo IBAM, com inscrições em andamento.</p><div class="mcp-news-facts"><span>200 vagas</span><span>Ensino médio</span><span>R$ 2.445,06</span><span>40h semanais</span><span>Inscrições até 15/10/2026</span></div></div>
      <a href="https://www.ibamsp-concursos.org.br/informacoes/197/" target="_blank" rel="noopener noreferrer">Ver notícia oficial no IBAM →</a>
    </article>
    <div class="mcp-train">
