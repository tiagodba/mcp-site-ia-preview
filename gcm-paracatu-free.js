(()=>{
  ...
  css.textContent=`
    ...
    #mcpPprnStudy{padding:46px 0;background:#f5f7fa;color:#08203d}.mcp-pprn-wrap{width:min(1080px,calc(100% - 32px));margin:auto}.mcp-pprn-card{display:grid;grid-template-columns:1.15fr .85fr;gap:26px;align-items:center;border:1px solid #dce2e9;border-top:4px solid #efbd26;border-radius:18px;background:#fff;box-shadow:0 16px 40px rgba(8,32,61,.12);padding:32px}.mcp-pprn-kicker{color:#9a7300;font-size:11px;font-weight:900;letter-spacing:1.6px;text-transform:uppercase;margin-bottom:10px}.mcp-pprn-card h2{margin:0 0 12px;font:700 36px/1.05 Georgia,serif;color:#08203d}.mcp-pprn-card h2 span{color:#b38708}.mcp-pprn-card p{margin:0;color:#667586;line-height:1.65;font-size:15px}.mcp-pprn-tags{display:flex;gap:8px;flex-wrap:wrap;margin:18px 0}.mcp-pprn-tags span{border:1px solid #dce2e9;background:#f8fafc;padding:8px 11px;border-radius:999px;font-size:11px;font-weight:800}.mcp-pprn-cta{display:inline-flex;text-decoration:none;background:#062a5d;color:#fff;font-weight:900;padding:12px 18px;border-radius:10px}.mcp-pprn-side{background:#071b39;color:#fff;border-radius:15px;padding:22px}.mcp-pprn-side b{color:#efbd26}.mcp-pprn-side ul{margin:12px 0 0;padding-left:18px;color:#d2dbea;line-height:1.65;font-size:13px}
  ...
  pprn.innerHTML=`<div class="mcp-pprn-wrap"><div class="mcp-pprn-card"><div><div class="mcp-pprn-kicker">Edital verticalizado MCP</div><h2>Polícia Penal <span>RN 2026</span></h2><p>Conteúdo programático dos cargos 401 e 402 organizado por disciplina e tópico, com navegação clicável para estudo direto no site.</p><div class="mcp-pprn-tags"><span>Concurso 002/2026</span><span>Cargos 401 e 402</span><span>Fonte oficial Avalia</span><span>Estudo interativo</span></div><a class="mcp-pprn-cta" href="/policia-penal-rn-2026.html">Abrir conteúdo programático →</a></div><div class="mcp-pprn-side"><b>Disciplinas organizadas</b><ul><li>Língua Portuguesa</li><li>História e Geoeconomia do RN</li><li>Ética no Serviço Público</li><li>Direito Constitucional e Administrativo</li><li>Direitos Humanos e Execução Penal</li><li>Legislação Específica</li><li>Direito Penal e Processo Penal</li></ul></div></div></div>`;
