(()=>{
  ...
  style.textContent=`
    ...
    @media(max-width:560px){.mcp-pcpr{grid-template-columns:1fr}.mcp-pcpr-cover{height:220px}.mcp-pcpr a{width:100%}#mcpCareerHub{padding:48px 0}.mcp-title{font-size:34px}.mcp-careers,.mcp-actions,.mcp-platforms,.mcp-q-grid{grid-template-columns:1fr}.mcp-central-head{align-items:flex-start;flex-direction:column}}
  `;
  ...
  block.querySelector('.mcp-train').insertAdjacentElement('afterend',pcprSpot);
